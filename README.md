...
This project was developed as part of the **Design Engineering (DE)** coursework.
...
- 🎮 Interactive 2D drone environment
- 📊 Live command display (HUD)
- ⚡ Smooth real-time movement
- 🔄 Animated propellers
- 🎨 Custom drone graphics created entirely in Pygame
- 🟢 Takeoff/Landing status indicator
- 📈 FPS monitoring
